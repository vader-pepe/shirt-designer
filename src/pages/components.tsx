...
export default function ComponentsPage() {
  ...
  return (
    <Layout>
      ...
      <main>
        <section className={clsx(mode === 'dark' ? 'bg-dark' : 'bg-white', color)}>
          <div
            className={clsx(
            ...
            <ol className='mt-8 space-y-6'>
              ...
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <ButtonLink variant='light' href='https://theodorusclarence.com'>
                    Light Variant
                  </ButtonLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  <Button variant='primary' leftIcon={HiPlus} rightIcon={HiArrowRight}>
                    Icon
                  </Button>
                  <Button
                    variant='outline'
                  ...
                  <Button variant='dark' leftIcon={HiPlus} rightIcon={HiArrowRight}>
                    Icon
                  </Button>
                  <Button variant='light' leftIcon={HiPlus} rightIcon={HiArrowRight}>
                    Icon
                  </Button>
                </div>
                ...
                <div className='flex flex-wrap gap-2'>
                  <Button size='sm' variant='primary' leftIcon={HiPlus} rightIcon={HiArrowRight}>
                    Icon
                  </Button>
                  <Button
                    size='sm'
                  ...
                  <Button size='sm' variant='dark' leftIcon={HiPlus} rightIcon={HiArrowRight}>
                    Icon
                  </Button>
                  <Button size='sm' variant='light' leftIcon={HiPlus} rightIcon={HiArrowRight}>
                    Icon
                  </Button>
                </div>
              ...
              <li className='space-y-2'>
                ...
                <p className={clsx('!mt-1 text-sm', textColor)}>Button with a text style</p>
                <div className='space-x-2'>
              ...
              <li className='space-y-2'>
                ...
                <p className={clsx('!mt-1 text-sm', textColor)}>Button with only icon inside</p>
                <div className='space-x-2'>
